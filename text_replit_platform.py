...
def test_authenticate_correct_password():
    ...
    # Act (дія)
    result = platform.authenticate("replit123")
...
def test_create_project_empty_name():
    ...
    # BVA: мінімальна довжина назви = 0
    # Негативний тест
...
def test_generate_ai_code_success():
    ...
    # Act
    code = platform.generate_ai_code(
        "створити калькулятор"
    )

    # Assert
    assert "Код створено ШІ" in code
    assert platform.projects["AIProject"]["code"] != ""
